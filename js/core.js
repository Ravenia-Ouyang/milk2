...
autoSendInterval: 5,
        ...
        periodCare: {
            ...
            careChance: 0.01,
            duringMessages: [
                '今天要不要先把热水和毯子准备好？我陪你慢慢熬过去。',
                '如果肚子不舒服，先别硬撑。你可以靠着我休息一会儿。',
                '这几天辛苦了，少一点勉强，多一点被照顾。'
            ],
            afterMessages: [
                '这几天也要慢慢把体力养回来，别一下子把自己推太紧。',
                '经期刚过，今天适合吃点舒服温热的东西。',
                '身体恢复期也算数，我还是会好好看着你。'
            ]
        },
...
if (partnerPersonas && partnerPersonas.length > 0 && Math.random() < 0.3) {
            ...
            for (let i = 0; i < replyCount; i++) {
                ...
                setTimeout(() => {
                    ...
                    if (typeof window.composeCareReplyLine === 'function') {
                        finalText = window.composeCareReplyLine(finalText);
                    }
